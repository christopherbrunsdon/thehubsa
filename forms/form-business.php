...
define('SHORTCODE_THEHUBSA_FORM_SIGNUP_BUSINESS', 'thehubsa_form_signup_business');
...
add_shortcode( SHORTCODE_THEHUBSA_FORM_SIGNUP_BUSINESS, array(new form_business() ,'shortcode'));
